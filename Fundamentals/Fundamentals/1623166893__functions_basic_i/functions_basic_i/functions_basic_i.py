...
# print(x)
#Prediction: will print nothing because no argument was passed into the function number_of_great_lakes()

# #6
# def add(b,c):
#     print(b+c)
# print(add(1,2) + add(2,3))
#Prediction: will print 8 (3 + 5) // Printed 3 then 5 on separate lines

# #7
# def concatenate(b,c):
#     return str(b)+str(c)
# print(concatenate(2,5))
#Prediction: will print 25
...
#Prediction: will print 7, 15 // printed out 7, 14, 21
